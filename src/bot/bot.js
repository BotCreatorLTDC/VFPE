...
const strings = {
    es: {
        welcome: "🌿 *Bienvenido a VFPE — Verify Plug Europe*\n\nEl único directorio verificado de plugs en Europa.\n\n👇 *Elige una opción:*",
        menu_find: "🗺 Buscar un Plug",
        ...
        no_clubs: "⚠️ *Aún no hay plugs verificados en {city}.*\n\nEstamos expandiéndonos. Sé el primero: ¡verifícate!",
        apply_btn: "✅ Solicitar Verificación",
        back: "← Volver",
        contact_btn: "→ Contactar Plug",
        info_btn: "ℹ️ Info",
        verified_clubs: "📍 *{city} — Plugs Verificados 🔌*\n\nAquí tienes los plugs verificados en tu ciudad.",
        req_submitted: "🎯 *¡Solicitud enviada!*\n\nRevisaremos tu plug en 24-48h. Recibirás una notificación aquí.",
        help_cmd: "🆘 *Comandos Disponibles:*\n\n/start - Menú principal\n/find - Buscador\n/verify - Registrar plug\n/community - Grupo\n/about - Info\n/cancel - Cancelar",
        verify_intro: "✅ *Verificación de Plug*\n\n¿Cómo se llama tu plug?\n(Escríbelo y envía)",
        verify_city: "📍 *¿En qué ciudad está?*",
        verify_tg: "💬 *¿Cuál es el usuario de Telegram?* (ej: @plugname)\n\n⚠️ Debe empezar por @",
        ...
        edit_btn: "✏️ Editar",
        cancel_btn: "❌ Cancelar",
        about_text: "ℹ️ *Sobre VFPE*\n\nSomos el primer directorio verificado de Europa. Conectamos socios con plugs reales y seguros."
    },
    en: {
        welcome: "🌿 *Welcome to VFPE — Verify Plug Europe*\n\nEurope's only verified directory of plugs.\n\n👇 *Choose an option:*",
        menu_find: "🗺 Find a Plug",
        menu_community: "👥 Community",
        menu_verify: "✅ Get Verified",
        menu_about: "ℹ️ About VFPE",
        select_country: "🌍 *Select your country:*",
        select_city: "🇪🇸 *Spain — Select your city:*",
        no_clubs: "⚠️ *No verified plugs found in {city} yet.*\n\nWe're expanding. Be the first — get verified!",
        apply_btn: "✅ Apply for Verification",
        back: "← Back",
        contact_btn: "→ Contact Plug",
        info_btn: "ℹ️ Info",
        verified_clubs: "📍 *{city} — Verified Plugs 🔌*\n\nHere are the verified plugs in your city.",
        req_submitted: "🎯 *Request submitted!*\n\nWe'll review your plug within 24-48h. You'll get a notification here.",
        help_cmd: "🆘 *Available Commands:*\n\n/start - Main menu\n/find - Search\n/verify - Register plug\n/community - Group\n/about - Info\n/cancel - Cancel",
        verify_intro: "✅ *Plug Verification*\n\nWhat is your plug's name?\n(Type and send)",
        verify_city: "📍 *In which city is it located?*",
        verify_tg: "💬 *What's the Telegram username?* (e.g. @plugname)\n\n⚠️ Must start with @",
        ...
        edit_btn: "✏️ Edit",
        cancel_btn: "❌ Cancel",
        about_text: "ℹ️ *About VFPE*\n\nWe are Europe's first verified directory. We connect members with real, safe plugs."
    }
};
...
bot.command("admin", async (ctx) => {
    ...
    const kb = new InlineKeyboard()
        ...
        .row()
        .webApp("👥 Demo: Modo Usuario", `${process.env.WEBAPP_URL || 'https://vfpe.onrender.com'}/index.html?demo=true&owner=false`)
        .webApp("👑 Demo: Modo Dueño", `${process.env.WEBAPP_URL || 'https://vfpe.onrender.com'}/index.html?demo=true&owner=true`)
        .row();

    if (pendingCount === 0) {
        return ctx.reply("✅ No hay solicitudes pendientes.\n\nPuedes gestionar el directorio o ver los modos demo aquí:", { 
            parse_mode: "Markdown", 
            reply_markup: kb 
        });
    }
